"""Uma lista com 10 valores e mostrar  posição onde se encontra o valor maior(sem utilizar funçóes prontas)"""

numero = []

for i in range(10):
    numerounitario = float(input("onde ta o valor maior: "))
    numero.append(numerounitario)    

posicao = 0
for i in range(10):
    if numero[posicao] < numero[i]: # se o valor da posição atual for menor que o 
